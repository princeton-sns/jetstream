...
template <class Aggregate>
std::vector<std::string>  MysqlAggregateQuantile<Aggregate>::get_column_types() const {
...
template <class Aggregate>
std::string MysqlAggregateQuantile<Aggregate>::get_update_on_insert_sql() const {
  assert(0);
  return "";
}
template<>
std::string MysqlAggregateQuantile<jetstream::LogHistogram>::get_update_on_insert_sql() const ;

template<>
std::string MysqlAggregateQuantile<jetstream::ReservoirSample>::get_update_on_insert_sql() const;
template<>
std::string MysqlAggregateQuantile<jetstream::CMMultiSketch>::get_update_on_insert_sql() const;
...
void MysqlAggregateQuantile<Aggregate>::populate_tuple_final(boost::shared_ptr<jetstream::Tuple> t, boost::shared_ptr<sql::ResultSet> resultset, int &column_index) const {
  std::string s = resultset->getString(column_index);
  ++column_index;
...
template<class Aggregate>
std::string MysqlAggregateQuantile<Aggregate>::get_select_clause_for_rollup() const {
  assert(0);
  return "";
}

template<>
std::string MysqlAggregateQuantile<jetstream::LogHistogram>::get_select_clause_for_rollup() const;

template<>
std::string MysqlAggregateQuantile<jetstream::ReservoirSample>::get_select_clause_for_rollup() const;

template<>
std::string MysqlAggregateQuantile<jetstream::CMMultiSketch>::get_select_clause_for_rollup() const;
